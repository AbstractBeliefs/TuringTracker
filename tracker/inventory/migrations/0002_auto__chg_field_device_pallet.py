...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Device.pallet'
        db.alter_column(u'inventory_device', 'pallet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.Pallet'], null=True))

    def backwards(self, orm):

        # Changing field 'Device.pallet'
        db.alter_column(u'inventory_device', 'pallet_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['inventory.Pallet']))
    ...
    models = {
        ...
        u'inventory.device': {
            ...
            'pallet': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.Pallet']", 'null': 'True'})
        },
        u'inventory.donor': {
