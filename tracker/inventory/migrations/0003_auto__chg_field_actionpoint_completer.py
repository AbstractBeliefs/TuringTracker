...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ActionPoint.completer'
        db.alter_column(u'inventory_actionpoint', 'completer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'ActionPoint.completer'
        db.alter_column(u'inventory_actionpoint', 'completer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']))
